...
const AdjectivesSection = ({
  ...
  const renderAdjectiveInfo = () => {
    if (!currentAdjectiveData?.examples) return null;
    ...
    return (
      <div className="mb-6">
        ...
        <div className="space-y-3">
          {currentAdjectiveData.examples.slice(0, 6).map((example, idx) => (
            <div key={idx} className="p-3 bg-amber-50 border border-amber-200 rounded">
              <div className="font-semibold text-amber-800">{example.polish}</div>
